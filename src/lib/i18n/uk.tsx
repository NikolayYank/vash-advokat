...
export const uk: Dict = {
    ...
    items: [
      {
        ...
        badges: [
          ...
          { icon: "🌍", label: <>Керівник представництва НААУ в&nbsp;Болгарії</> },
        ...
        bio: [
          ...
          <>
            <strong>2013</strong>&nbsp;— орден «Видатний адвокат України», вища відзнака Ради адвокатів. Представник адвокатів Харківської області в&nbsp;Раді адвокатів України. Керівник представництва НААУ у&nbsp;Республіці Болгарія.
          </>,
          <>
      ...
      },
      {
        ...
        imageAlt: "Зіновій Степанович Галаван — партнер Фундації адвокатів України",
        name: "Зіновій Степанович Галаван",
        title: (
          <>Партнер Фундації. Керівник адвокатського бюро «Зіновій Галаван і&nbsp;партнери»</>
        ),
        badges: [
        ...
        bio: [
          <>
            У&nbsp;праві&nbsp;— <strong>з&nbsp;1979&nbsp;року</strong>. Пройшов шлях від&nbsp;слідчого до&nbsp;<strong>начальника слідчого управління ГУ&nbsp;МВС України у&nbsp;Харківській області</strong>. Полковник міліції у&nbsp;відставці.
          </>,
          <>
          ...
          <>
            Керівник адвокатського бюро «Зіновій&nbsp;Галаван і&nbsp;партнери», партнер Фундації. Спеціалізація&nbsp;— <strong>кримінальний захист у&nbsp;найскладніших провадженнях</strong>. Знає кримінальний процес з&nbsp;обох боків&nbsp;— і&nbsp;слідства, і&nbsp;захисту.
          </>,
        ],
        quote: (
          <>
  ...
  blogPreview: {
    ...
    subscribeNote: <>Або підпишіться: щотижня надсилаємо новий розбір реальної ситуації. Без спаму, відписка одним кліком.</>,
    readLabel: "читання",
