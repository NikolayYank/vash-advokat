...
const servicesList = [
  {
    ...
    Icon: ShieldAlert,
    title: "Шахрайство",
    desc: "Повернення коштів, докази для суду, кіберполіція",
          ...
          <div className="founder">
            ...
            <div className="founder-info">
              ...
              <p>
                ...
                11 500 справ — від побутових спорів до кримінальних, цивільних і
                бізнесових.
              </p>
              <p>
          ...
          <div>
            ...
            <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: 14, marginBottom: "var(--space-xl)" }}>
              {[
                ...
                { strong: "Документи, що працюють як видимий захист", thin: " — пластиковий ордер і захисні знаки на двері" },
              ].map((item) => (
                <li
                  key={item.strong}
                  style={{
