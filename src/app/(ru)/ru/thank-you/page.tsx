...
import "../../../(uk)/thank-you/thank-you.css";

export const metadata: Metadata = {
  title: ru.thankYou.metaTitle,
  description: ru.thankYou.metaDescription,
...
const dict = ru.thankYou;

export default function ThankYouPageRu() {
  return (
    <>
      <SiteHeader dict={ru} locale="ru" switchPath="/thank-you/" />
      ...
      <main className="thank-you">
        <div className="thank-you-container">
          ...
          <section className="thank-you-social" aria-labelledby="thank-you-social-h">
            ...
            <a
              href="#"
              className="thank-you-social-card thank-you-social-card--primary thank-you-social-card--placeholder"
              aria-disabled="true"
              tabIndex={-1}
            ...
            <a
              href="#"
              className="thank-you-social-card thank-you-social-card--secondary thank-you-social-card--placeholder"
              aria-disabled="true"
              tabIndex={-1}
          ...
          <Link href="/ru" className="btn btn-outline thank-you-back">
            {dict.backHomeLabel}
          </Link>
        </div>
      </main>
