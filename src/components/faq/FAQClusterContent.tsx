...
const labels = {
  uk: {
    ...
    extraContext:
      "Практичні матеріали для людей у конкретній ситуації. Не замінюють індивідуальну консультацію.",
  },
  ru: {
    ...
    extraContext:
      "Практические материалы для людей в конкретной ситуации. Не заменяют индивидуальную консультацию.",
  },
} as const;
